                ...
                <div class="row">
                   <div class="col-md-12 col-xs-12 top-5">
                      <div class="cl-logo fl">
                         <h1 class="logo">
                            <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="{{asset('frontend/images/logo-viet-nam-travel.png')}}" alt="logo"/></a>
                         </h1>
                      </div>
                      <div class="cl-bnt fl">
                         <div class="banner-top">
                            <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="{{asset('frontend/images/banner-top.jpg')}}" alt="banner top"></a>
                         </div>
                      </div>
                                          ...
                                          @foreach($categories as $key => $sub_cate)
                                             @if($sub_cate->category_parent == $cate->id)
                                                <li class="" style="border-color:white">
                                                   <a href="{{route('tour', [$sub_cate->slug])}}" class="">
       ...
       <div class="container-fluid">
          <div class="slider-wrapper theme-default">
             <div id="slider-master" class="nivoSlider">
                <a href="https://vietnamtravel.net.vn/vi/loai-tour/30-4/1.html"><img src="{{asset('frontend/images/bai-dinh-trang-an.jpg')}}" data-thumb="imgs/bai-dinh-trang-an.jpg" alt="aa" title="" /></a>
